...
public class EmployeeDetails extends javax.swing.JFrame {
    ...
    public EmployeeDetails() {
     initComponents();
        loadCSV("/Users/chadleyayco/Documents/Group12-MS1-MotorPHApplication-main 2/src/CSV/MotorPH Employees_empdetails.csv");
     ...
     tblERecords.addMouseListener(new java.awt.event.MouseAdapter() {
        public void mouseClicked(java.awt.event.MouseEvent evt) {
            ...
            if (selectedRow != -1) {
                ...
                TFclothingallow.setText(tblERecords.getValueAt(selectedRow, 12).toString());
            }
        }
    });
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
            ...
            private void saveToCSV() {
                try {
                    DefaultTableModel model = (DefaultTableModel) tblERecords.getModel();
                    File file = new File("/Users/chadleyayco/Documents/Group12-MS1-MotorPHApplication-main 2/src/CSV/MotorPH Employees_empdetails.csv");
